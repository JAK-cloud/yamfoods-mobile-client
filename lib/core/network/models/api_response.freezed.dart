...
mixin _$ApiResponse<T> {
 ...
 bool get success; T get data; MetaModel get meta;
...
@useResult
$Res call({
 bool success, T data, MetaModel meta
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool success,  T data,  MetaModel meta)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool success,  T data,  MetaModel meta)  $default,) {final _that = this;
switch (_that) {
case _ApiResponse():
return $default(_that.success,_that.data,_that.meta);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool success,  T data,  MetaModel meta)?  $default,) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
return $default(_that.success,_that.data,_that.meta);case _:
  return null;
...
class _ApiResponse<T> implements ApiResponse<T> {
  const _ApiResponse({required this.success, required this.data, required this.meta});
