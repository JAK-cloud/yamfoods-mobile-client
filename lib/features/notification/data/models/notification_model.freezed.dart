...
mixin _$NotificationModel {
 ...
 int get id; String get type; String get title; String get body; bool? get isRead; int? get orderId; int? get productId; DateTime get createdAt;
...
@override
String toString() {
  return 'NotificationModel(id: $id, type: $type, title: $title, body: $body, isRead: $isRead, orderId: $orderId, productId: $productId, createdAt: $createdAt)';
}
...
class _NotificationModel extends NotificationModel {
  const _NotificationModel({required this.id, required this.type, required this.title, required this.body, this.isRead, this.orderId, this.productId, required this.createdAt}): super._();
