...
mixin _$FaqModel {
 ...
 int get id; String get question; String get answer; DateTime get createdAt; DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,question,answer,createdAt,updatedAt);

@override
String toString() {
  return 'FaqModel(id: $id, question: $question, answer: $answer, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int id, String question, String answer, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of FaqModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? question = null,Object? answer = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String question,  String answer,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FaqModel() when $default != null:
return $default(_that.id,_that.question,_that.answer,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String question,  String answer,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _FaqModel():
return $default(_that.id,_that.question,_that.answer,_that.createdAt,_that.updatedAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String question,  String answer,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _FaqModel() when $default != null:
return $default(_that.id,_that.question,_that.answer,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _FaqModel extends FaqModel {
  const _FaqModel({required this.id, required this.question, required this.answer, required this.createdAt, required this.updatedAt}): super._();
...
/// Create a copy of FaqModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? question = null,Object? answer = null,Object? createdAt = null,Object? updatedAt = null,}) {
