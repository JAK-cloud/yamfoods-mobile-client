...
mixin _$ProductImageModel {
 ...
 String get url;@JsonKey(name: 'is_main') bool get isMain;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductImageModel&&(identical(other.url, url) || other.url == url)&&(identical(other.isMain, isMain) || other.isMain == isMain));
}
...
@override
String toString() {
  return 'ProductImageModel(url: $url, isMain: $isMain)';
}
...
@useResult
$Res call({
 String url,@JsonKey(name: 'is_main') bool isMain
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String url, @JsonKey(name: 'is_main')  bool isMain)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductImageModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String url, @JsonKey(name: 'is_main')  bool isMain)  $default,) {final _that = this;
switch (_that) {
case _ProductImageModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String url, @JsonKey(name: 'is_main')  bool isMain)?  $default,) {final _that = this;
switch (_that) {
case _ProductImageModel() when $default != null:
return $default(_that.url,_that.isMain);case _:
  return null;
...
class _ProductImageModel implements ProductImageModel {
  const _ProductImageModel({required this.url, @JsonKey(name: 'is_main') required this.isMain});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProductImageModel&&(identical(other.url, url) || other.url == url)&&(identical(other.isMain, isMain) || other.isMain == isMain));
}
