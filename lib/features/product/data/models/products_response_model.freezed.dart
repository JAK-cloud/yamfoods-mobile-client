...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductsResponseModel&&const DeepCollectionEquality().equals(other.products, products));
}
...
class _ProductsResponseModel implements ProductsResponseModel {
  const _ProductsResponseModel({required final  List<ProductModel> products}): _products = products;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProductsResponseModel&&const DeepCollectionEquality().equals(other._products, _products));
}
