  ...
  Future<ApiResponse<ProductsResponseModel>> getAllDiscountedProducts(
    ...
    final _options = _setStreamType<ApiResponse<ProductsResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/product/get-all-discounted-products/${branchId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<ApiResponse<ProductsResponseModel>> getAllFeaturedProducts(
    ...
    final _options = _setStreamType<ApiResponse<ProductsResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/product/get-all-featured-products/${branchId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<ApiResponse<ProductsResponseModel>> getAllCategoryProducts(
    ...
    final _options = _setStreamType<ApiResponse<ProductsResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/product/get-all-category-products/${branchId}/${categoryId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<ApiResponse<ProductsResponseModel>> getAllSubcategoryProducts(
    ...
    final _options = _setStreamType<ApiResponse<ProductsResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/product/get-all-sub-category-products/${branchId}/${subCategoryId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<ApiResponse<ProductModel>> getProduct(
    ...
    final _options = _setStreamType<ApiResponse<ProductModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/product/get-product/${branchId}/${productId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
