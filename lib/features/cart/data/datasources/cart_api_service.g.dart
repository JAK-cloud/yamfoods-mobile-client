...
class _CartApiService implements CartApiService {
  ...
  @override
  Future<ApiResponse<CartsResponseModel>> getAllCarts(int branchId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<CartsResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/cart/get-all-carts/${branchId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    late ApiResponse<CartsResponseModel> _value;
    try {
      _value = ApiResponse<CartsResponseModel>.fromJson(
        _result.data!,
        (json) => CartsResponseModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
