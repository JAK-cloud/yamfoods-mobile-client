...
class _CategoryApiService implements CategoryApiService {
  ...
  Future<ApiResponse<CategoriesResponseModel>> getAllCategories(
    ...
    final _options = _setStreamType<ApiResponse<CategoriesResponseModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/category/get-all-categories/${branchId}',
    ...
    late ApiResponse<CategoriesResponseModel> _value;
    try {
      _value = ApiResponse<CategoriesResponseModel>.fromJson(
        _result.data!,
        (json) =>
