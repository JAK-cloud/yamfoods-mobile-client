...
class _AddressApiService implements AddressApiService {
  _AddressApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ApiResponse<List<AddressModel>>> getAddresses() async {
    ...
    final _options = _setStreamType<ApiResponse<List<AddressModel>>>(
  ...
  Future<ApiResponse<AddressModel>> createAddress(
    ...
    _data.addAll(body);
    final _options = _setStreamType<ApiResponse<AddressModel>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<AddressModel> _value;
    try {
      _value = ApiResponse<AddressModel>.fromJson(
        _result.data!,
