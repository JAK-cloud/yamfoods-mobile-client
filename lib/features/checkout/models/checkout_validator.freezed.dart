...
mixin _$CheckoutValidation {
 ...
 bool get isValid; String? get addressError; String? get tableNumberError; String? get promoCodeError; String? get pointsError; String? get scheduleError; String? get paymentError; String? get generalError;
...
@useResult
$Res call({
 bool isValid, String? addressError, String? tableNumberError, String? promoCodeError, String? pointsError, String? scheduleError, String? paymentError, String? generalError
});
...
/// Create a copy of CheckoutValidation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isValid = null,Object? addressError = freezed,Object? tableNumberError = freezed,Object? promoCodeError = freezed,Object? pointsError = freezed,Object? scheduleError = freezed,Object? paymentError = freezed,Object? generalError = freezed,}) {
...
as String?,tableNumberError: freezed == tableNumberError ? _self.tableNumberError : tableNumberError // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isValid,  String? addressError,  String? tableNumberError,  String? promoCodeError,  String? pointsError,  String? scheduleError,  String? paymentError,  String? generalError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CheckoutValidation() when $default != null:
return $default(_that.isValid,_that.addressError,_that.tableNumberError,_that.promoCodeError,_that.pointsError,_that.scheduleError,_that.paymentError,_that.generalError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isValid,  String? addressError,  String? tableNumberError,  String? promoCodeError,  String? pointsError,  String? scheduleError,  String? paymentError,  String? generalError)  $default,) {final _that = this;
switch (_that) {
case _CheckoutValidation():
return $default(_that.isValid,_that.addressError,_that.tableNumberError,_that.promoCodeError,_that.pointsError,_that.scheduleError,_that.paymentError,_that.generalError);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isValid,  String? addressError,  String? tableNumberError,  String? promoCodeError,  String? pointsError,  String? scheduleError,  String? paymentError,  String? generalError)?  $default,) {final _that = this;
switch (_that) {
case _CheckoutValidation() when $default != null:
return $default(_that.isValid,_that.addressError,_that.tableNumberError,_that.promoCodeError,_that.pointsError,_that.scheduleError,_that.paymentError,_that.generalError);case _:
  return null;
...
class _CheckoutValidation implements CheckoutValidation {
  const _CheckoutValidation({required this.isValid, this.addressError, this.tableNumberError, this.promoCodeError, this.pointsError, this.scheduleError, this.paymentError, this.generalError});
  

@override final  bool isValid;
@override final  String? addressError;
@override final  String? tableNumberError;
...
/// Create a copy of CheckoutValidation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isValid = null,Object? addressError = freezed,Object? tableNumberError = freezed,Object? promoCodeError = freezed,Object? pointsError = freezed,Object? scheduleError = freezed,Object? paymentError = freezed,Object? generalError = freezed,}) {
