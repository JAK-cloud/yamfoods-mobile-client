...
class _OrderApiService implements OrderApiService {
  ...
  Future<ApiResponse<CreateOrderResponseModel>> createOrder(
    ...
    _data.addAll(body);
    final _options = _setStreamType<ApiResponse<CreateOrderResponseModel>>(
    ...
    late ApiResponse<CreateOrderResponseModel> _value;
    try {
      _value = ApiResponse<CreateOrderResponseModel>.fromJson(
        _result.data!,
        (json) =>
  ...
  Future<ApiResponse<OrderDetailModel>> getOrderDetail(int orderId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<OrderDetailModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<OrderDetailModel> _value;
    try {
      _value = ApiResponse<OrderDetailModel>.fromJson(
        _result.data!,
  ...
  @override
  Future<ApiResponse<OrderDetailModel?>> getOutForDeliveryOrder() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<OrderDetailModel?>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/order/get-out-for-delivery-order',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
