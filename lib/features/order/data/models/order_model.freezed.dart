...
mixin _$OrderModel {
 ...
 int get id; String get orderReference; int? get userId; String get userPhone; int get branchId; String get qrCode; String get status; String get type; int? get delivererId;// nullable because this order class intended for customer not for deliverer. for deliverer it should be required
 String? get delivererPhone; DateTime? get scheduledAt; String? get note; String? get tableNumber; int get quantity;@JsonKey(fromJson: parseDouble) double get subtotal;@JsonKey(fromJson: parseDouble) double? get vatTotal;@JsonKey(fromJson: parseDouble) double get deliveryFee; int? get pointUsed;@JsonKey(fromJson: parseDouble) double? get pointDiscount; String? get promoCode;@JsonKey(fromJson: parseDouble) double? get promoCodeDiscount;@JsonKey(fromJson: parseDouble) double? get discountTotal;@JsonKey(fromJson: parseDouble) double get totalAmount; OrderLocationModel get branchLocation; OrderLocationModel get deliveryLocation; DateTime get createdAt; DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,orderReference,userId,userPhone,branchId,qrCode,status,type,delivererId,delivererPhone,scheduledAt,note,tableNumber,quantity,subtotal,vatTotal,deliveryFee,pointUsed,pointDiscount,promoCode,promoCodeDiscount,discountTotal,totalAmount,branchLocation,deliveryLocation,createdAt,updatedAt]);

@override
String toString() {
  return 'OrderModel(id: $id, orderReference: $orderReference, userId: $userId, userPhone: $userPhone, branchId: $branchId, qrCode: $qrCode, status: $status, type: $type, delivererId: $delivererId, delivererPhone: $delivererPhone, scheduledAt: $scheduledAt, note: $note, tableNumber: $tableNumber, quantity: $quantity, subtotal: $subtotal, vatTotal: $vatTotal, deliveryFee: $deliveryFee, pointUsed: $pointUsed, pointDiscount: $pointDiscount, promoCode: $promoCode, promoCodeDiscount: $promoCodeDiscount, discountTotal: $discountTotal, totalAmount: $totalAmount, branchLocation: $branchLocation, deliveryLocation: $deliveryLocation, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
/// Create a copy of OrderModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? orderReference = null,Object? userId = freezed,Object? userPhone = null,Object? branchId = null,Object? qrCode = null,Object? status = null,Object? type = null,Object? delivererId = freezed,Object? delivererPhone = freezed,Object? scheduledAt = freezed,Object? note = freezed,Object? tableNumber = freezed,Object? quantity = null,Object? subtotal = null,Object? vatTotal = freezed,Object? deliveryFee = null,Object? pointUsed = freezed,Object? pointDiscount = freezed,Object? promoCode = freezed,Object? promoCodeDiscount = freezed,Object? discountTotal = freezed,Object? totalAmount = null,Object? branchLocation = null,Object? deliveryLocation = null,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,orderReference: null == orderReference ? _self.orderReference : orderReference // ignore: cast_nullable_to_non_nullable
...
as OrderLocationModel,deliveryLocation: null == deliveryLocation ? _self.deliveryLocation : deliveryLocation // ignore: cast_nullable_to_non_nullable
as OrderLocationModel,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$OrderLocationModelCopyWith<$Res> get branchLocation {
  
  return $OrderLocationModelCopyWith<$Res>(_self.branchLocation, (value) {
...
@override
@pragma('vm:prefer-inline')
$OrderLocationModelCopyWith<$Res> get deliveryLocation {
  
  return $OrderLocationModelCopyWith<$Res>(_self.deliveryLocation, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String orderReference,  int? userId,  String userPhone,  int branchId,  String qrCode,  String status,  String type,  int? delivererId,  String? delivererPhone,  DateTime? scheduledAt,  String? note,  String? tableNumber,  int quantity, @JsonKey(fromJson: parseDouble)  double subtotal, @JsonKey(fromJson: parseDouble)  double? vatTotal, @JsonKey(fromJson: parseDouble)  double deliveryFee,  int? pointUsed, @JsonKey(fromJson: parseDouble)  double? pointDiscount,  String? promoCode, @JsonKey(fromJson: parseDouble)  double? promoCodeDiscount, @JsonKey(fromJson: parseDouble)  double? discountTotal, @JsonKey(fromJson: parseDouble)  double totalAmount,  OrderLocationModel branchLocation,  OrderLocationModel deliveryLocation,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderModel() when $default != null:
return $default(_that.id,_that.orderReference,_that.userId,_that.userPhone,_that.branchId,_that.qrCode,_that.status,_that.type,_that.delivererId,_that.delivererPhone,_that.scheduledAt,_that.note,_that.tableNumber,_that.quantity,_that.subtotal,_that.vatTotal,_that.deliveryFee,_that.pointUsed,_that.pointDiscount,_that.promoCode,_that.promoCodeDiscount,_that.discountTotal,_that.totalAmount,_that.branchLocation,_that.deliveryLocation,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String orderReference,  int? userId,  String userPhone,  int branchId,  String qrCode,  String status,  String type,  int? delivererId,  String? delivererPhone,  DateTime? scheduledAt,  String? note,  String? tableNumber,  int quantity, @JsonKey(fromJson: parseDouble)  double subtotal, @JsonKey(fromJson: parseDouble)  double? vatTotal, @JsonKey(fromJson: parseDouble)  double deliveryFee,  int? pointUsed, @JsonKey(fromJson: parseDouble)  double? pointDiscount,  String? promoCode, @JsonKey(fromJson: parseDouble)  double? promoCodeDiscount, @JsonKey(fromJson: parseDouble)  double? discountTotal, @JsonKey(fromJson: parseDouble)  double totalAmount,  OrderLocationModel branchLocation,  OrderLocationModel deliveryLocation,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _OrderModel():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String orderReference,  int? userId,  String userPhone,  int branchId,  String qrCode,  String status,  String type,  int? delivererId,  String? delivererPhone,  DateTime? scheduledAt,  String? note,  String? tableNumber,  int quantity, @JsonKey(fromJson: parseDouble)  double subtotal, @JsonKey(fromJson: parseDouble)  double? vatTotal, @JsonKey(fromJson: parseDouble)  double deliveryFee,  int? pointUsed, @JsonKey(fromJson: parseDouble)  double? pointDiscount,  String? promoCode, @JsonKey(fromJson: parseDouble)  double? promoCodeDiscount, @JsonKey(fromJson: parseDouble)  double? discountTotal, @JsonKey(fromJson: parseDouble)  double totalAmount,  OrderLocationModel branchLocation,  OrderLocationModel deliveryLocation,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _OrderModel() when $default != null:
return $default(_that.id,_that.orderReference,_that.userId,_that.userPhone,_that.branchId,_that.qrCode,_that.status,_that.type,_that.delivererId,_that.delivererPhone,_that.scheduledAt,_that.note,_that.tableNumber,_that.quantity,_that.subtotal,_that.vatTotal,_that.deliveryFee,_that.pointUsed,_that.pointDiscount,_that.promoCode,_that.promoCodeDiscount,_that.discountTotal,_that.totalAmount,_that.branchLocation,_that.deliveryLocation,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _OrderModel extends OrderModel {
  const _OrderModel({required this.id, required this.orderReference, this.userId, required this.userPhone, required this.branchId, required this.qrCode, required this.status, required this.type, this.delivererId, this.delivererPhone, this.scheduledAt, this.note, this.tableNumber, required this.quantity, @JsonKey(fromJson: parseDouble) required this.subtotal, @JsonKey(fromJson: parseDouble) this.vatTotal, @JsonKey(fromJson: parseDouble) required this.deliveryFee, this.pointUsed, @JsonKey(fromJson: parseDouble) this.pointDiscount, this.promoCode, @JsonKey(fromJson: parseDouble) this.promoCodeDiscount, @JsonKey(fromJson: parseDouble) this.discountTotal, @JsonKey(fromJson: parseDouble) required this.totalAmount, required this.branchLocation, required this.deliveryLocation, required this.createdAt, required this.updatedAt}): super._();
...
@override final  OrderLocationModel branchLocation;
@override final  OrderLocationModel deliveryLocation;
...
@override $OrderLocationModelCopyWith<$Res> get branchLocation;@override $OrderLocationModelCopyWith<$Res> get deliveryLocation;
...
/// Create a copy of OrderModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? orderReference = null,Object? userId = freezed,Object? userPhone = null,Object? branchId = null,Object? qrCode = null,Object? status = null,Object? type = null,Object? delivererId = freezed,Object? delivererPhone = freezed,Object? scheduledAt = freezed,Object? note = freezed,Object? tableNumber = freezed,Object? quantity = null,Object? subtotal = null,Object? vatTotal = freezed,Object? deliveryFee = null,Object? pointUsed = freezed,Object? pointDiscount = freezed,Object? promoCode = freezed,Object? promoCodeDiscount = freezed,Object? discountTotal = freezed,Object? totalAmount = null,Object? branchLocation = null,Object? deliveryLocation = null,Object? createdAt = null,Object? updatedAt = null,}) {
