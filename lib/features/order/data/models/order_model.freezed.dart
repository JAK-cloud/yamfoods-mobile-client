...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,userPhone,branchId,qrCode,status,type,delivererId,delivererPhone,scheduledAt,note,tableNumber,quantity,subtotal,vatTotal,deliveryFee,pointUsed,pointDiscount,promoCode,promoCodeDiscount,discountTotal,totalAmount,branchLocation,deliveryLocation,createdAt,updatedAt]);

@override
String toString() {
  return 'OrderModel(id: $id, userId: $userId, userPhone: $userPhone, branchId: $branchId, qrCode: $qrCode, status: $status, type: $type, delivererId: $delivererId, delivererPhone: $delivererPhone, scheduledAt: $scheduledAt, note: $note, tableNumber: $tableNumber, quantity: $quantity, subtotal: $subtotal, vatTotal: $vatTotal, deliveryFee: $deliveryFee, pointUsed: $pointUsed, pointDiscount: $pointDiscount, promoCode: $promoCode, promoCodeDiscount: $promoCodeDiscount, discountTotal: $discountTotal, totalAmount: $totalAmount, branchLocation: $branchLocation, deliveryLocation: $deliveryLocation, createdAt: $createdAt, updatedAt: $updatedAt)';
}
