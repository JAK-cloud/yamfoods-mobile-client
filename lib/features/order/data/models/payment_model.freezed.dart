...
mixin _$PaymentModel {
 ...
 String? get telebirrPaymentOrderId;@JsonKey(fromJson: parseDouble) double get amount; DateTime? get transTime; String? get currency; String? get chapaTxnRef; String? get chapaMethod; DateTime get date;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orderId,method,status,transId,telebirrPaymentOrderId,amount,transTime,currency,chapaTxnRef,chapaMethod,date);

@override
String toString() {
  return 'PaymentModel(id: $id, orderId: $orderId, method: $method, status: $status, transId: $transId, telebirrPaymentOrderId: $telebirrPaymentOrderId, amount: $amount, transTime: $transTime, currency: $currency, chapaTxnRef: $chapaTxnRef, chapaMethod: $chapaMethod, date: $date)';
}
...
@useResult
$Res call({
 int id, int orderId, String method, String status, String? transId, String? telebirrPaymentOrderId,@JsonKey(fromJson: parseDouble) double amount, DateTime? transTime, String? currency, String? chapaTxnRef, String? chapaMethod, DateTime date
});
...
/// Create a copy of PaymentModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? orderId = null,Object? method = null,Object? status = null,Object? transId = freezed,Object? telebirrPaymentOrderId = freezed,Object? amount = null,Object? transTime = freezed,Object? currency = freezed,Object? chapaTxnRef = freezed,Object? chapaMethod = freezed,Object? date = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int orderId,  String method,  String status,  String? transId,  String? telebirrPaymentOrderId, @JsonKey(fromJson: parseDouble)  double amount,  DateTime? transTime,  String? currency,  String? chapaTxnRef,  String? chapaMethod,  DateTime date)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaymentModel() when $default != null:
return $default(_that.id,_that.orderId,_that.method,_that.status,_that.transId,_that.telebirrPaymentOrderId,_that.amount,_that.transTime,_that.currency,_that.chapaTxnRef,_that.chapaMethod,_that.date);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int orderId,  String method,  String status,  String? transId,  String? telebirrPaymentOrderId, @JsonKey(fromJson: parseDouble)  double amount,  DateTime? transTime,  String? currency,  String? chapaTxnRef,  String? chapaMethod,  DateTime date)  $default,) {final _that = this;
switch (_that) {
case _PaymentModel():
return $default(_that.id,_that.orderId,_that.method,_that.status,_that.transId,_that.telebirrPaymentOrderId,_that.amount,_that.transTime,_that.currency,_that.chapaTxnRef,_that.chapaMethod,_that.date);}
}
...
class _PaymentModel extends PaymentModel {
  const _PaymentModel({required this.id, required this.orderId, required this.method, required this.status, this.transId, this.telebirrPaymentOrderId, @JsonKey(fromJson: parseDouble) required this.amount, this.transTime, this.currency, this.chapaTxnRef, this.chapaMethod, required this.date}): super._();
...
/// Create a copy of PaymentModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? orderId = null,Object? method = null,Object? status = null,Object? transId = freezed,Object? telebirrPaymentOrderId = freezed,Object? amount = null,Object? transTime = freezed,Object? currency = freezed,Object? chapaTxnRef = freezed,Object? chapaMethod = freezed,Object? date = null,}) {
