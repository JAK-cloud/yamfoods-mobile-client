...
mixin _$Orderr {
 ...
 int get id; String get orderReference; int? get userId;//this field is not needed but it does not affect
 ...
 String? get delivererPhone; DateTime? get scheduledAt; String? get note; String? get tableNumber; int get quantity; double get subtotal; double? get vatTotal; double get deliveryFee; int? get pointUsed; double? get pointDiscount; String? get promoCode; double? get promoCodeDiscount; double? get discountTotal; double get totalAmount; OrderLocation get branchLocation; OrderLocation get deliveryLocation; DateTime get createdAt; DateTime get updatedAt;
...
@useResult
$Res call({
 int id, String orderReference, int? userId, String userPhone, int branchId, String qrCode, String status, String type, int? delivererId, String? delivererPhone, DateTime? scheduledAt, String? note, String? tableNumber, int quantity, double subtotal, double? vatTotal, double deliveryFee, int? pointUsed, double? pointDiscount, String? promoCode, double? promoCodeDiscount, double? discountTotal, double totalAmount, OrderLocation branchLocation, OrderLocation deliveryLocation, DateTime createdAt, DateTime updatedAt
});
...
class _Orderr implements Orderr {
  const _Orderr({required this.id, required this.orderReference, this.userId, required this.userPhone, required this.branchId, required this.qrCode, required this.status, required this.type, this.delivererId, this.delivererPhone, this.scheduledAt, this.note, this.tableNumber, required this.quantity, required this.subtotal, this.vatTotal, required this.deliveryFee, this.pointUsed, this.pointDiscount, this.promoCode, this.promoCodeDiscount, this.discountTotal, required this.totalAmount, required this.branchLocation, required this.deliveryLocation, required this.createdAt, required this.updatedAt});
