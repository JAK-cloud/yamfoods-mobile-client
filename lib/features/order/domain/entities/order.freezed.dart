...
@override
String toString() {
  return 'Orderr(id: $id, userId: $userId, userPhone: $userPhone, branchId: $branchId, qrCode: $qrCode, status: $status, type: $type, delivererId: $delivererId, delivererPhone: $delivererPhone, scheduledAt: $scheduledAt, note: $note, tableNumber: $tableNumber, quantity: $quantity, subtotal: $subtotal, vatTotal: $vatTotal, deliveryFee: $deliveryFee, pointUsed: $pointUsed, pointDiscount: $pointDiscount, promoCode: $promoCode, promoCodeDiscount: $promoCodeDiscount, discountTotal: $discountTotal, totalAmount: $totalAmount, branchLocation: $branchLocation, deliveryLocation: $deliveryLocation, createdAt: $createdAt, updatedAt: $updatedAt)';
}
