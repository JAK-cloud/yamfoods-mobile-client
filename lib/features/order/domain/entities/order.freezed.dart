...
@useResult
$Res call({
 int id, int? userId, String userPhone, int branchId, String qrCode, String status, String type, int? delivererId, String? delivererPhone, DateTime? scheduledAt, String? note, int quantity, double subtotal, double? vatTotal, double deliveryFee, int? pointUsed, double? pointDiscount, String? promoCode, double? promoCodeDiscount, double? discountTotal, double totalAmount, DateTime createdAt, DateTime updatedAt
});
...
class _Orderr implements Orderr {
  const _Orderr({required this.id, this.userId, required this.userPhone, required this.branchId, required this.qrCode, required this.status, required this.type, this.delivererId, this.delivererPhone, this.scheduledAt, this.note, required this.quantity, required this.subtotal, this.vatTotal, required this.deliveryFee, this.pointUsed, this.pointDiscount, this.promoCode, this.promoCodeDiscount, this.discountTotal, required this.totalAmount, required this.createdAt, required this.updatedAt});
